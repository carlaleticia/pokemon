...
const createPokemonCard = (pokemon) => {
	...
	const createPokemonFullCard = (pokemon) => {
		let pokeDescription = document.getElementsByClassName('card');
		let pokeCardDesc = document.createElement('div');
		pokeCardDesc.classList.add('pokeCardContainer');

		// pokeDescription.addEventListener('click', (createPokemonFullCard.innerHTML = displayInfoInnerHTML));
